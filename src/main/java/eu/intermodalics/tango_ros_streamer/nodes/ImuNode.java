...
public class ImuNode extends AbstractNodeMain implements NodeMain, SensorEventListener {
    ...
    public void onStart(ConnectedNode connectedNode) {
        ...
        mSensorManager.registerListener(this, mRotationSensor, 20000);
        mSensorManager.registerListener(this, mGyroscopeSensor, 20000);
        mSensorManager.registerListener(this, mAccelerometerSensor, 20000);
    }
